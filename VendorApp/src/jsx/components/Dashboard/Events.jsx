              ...
              <div className='card'>
                <div className='card-header border-0'>
                  ...
                  <Dropdown className='btn-group'>
                    <Dropdown.Toggle className='btn btn-primary btn-sm' type='button'>
                      This Week
                    </Dropdown.Toggle>
                ...
                <div className='card-media'>
                  ...
                  <div className='overlay-bx row p-3 p-xl-4'>
                    <div className='col-lg-6 col-10 p-0'>
                      <h3 className='text-white mb-4'>Beautiful Fireworks Show In The New Year Night 2024.</h3>
                      <Link className='btn btn-primary btn-sm rounded' to='/events'>
                        <svg
                          className='me-3'
                          width={16}
                          height={16}
