                    ...
                    <div className="widget-timeline-status">
                        <ul className="timeline">
                            ...
                            <li>
                                ...
                                <div className="timeline-panel">
                                    <span className=" fs-14 fw-semibold">john just buy your product Sell  <span className="text-primary">$250</span></span>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div className="timeline-panel">
                                    <span className="fs-14 fw-semibold">StumbleUpon is acquired by <span className="text-primary">eBay</span></span>
                                </div>
                            </li>
                            <li>
