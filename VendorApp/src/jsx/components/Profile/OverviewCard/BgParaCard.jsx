        ...
        <Fragment>
            <div className="card card-comment">
                <div className="card-body pb-0">
                    <div className="d-flex justify-content-between mb-2">
                        <div className="d-flex align-items-center py-2">
                            <div className="d-inline-block position-relative">
                                <img src={IMAGES.Avatar5} alt="avat5" className="rounded avatar avatar-md"/>
                            </div>
                    ...
                    <div className="post-quote post-quote-img bg-purple p-4 text-center mb-2 rounded" style={{backgroundImage: `url(${IMAGES.PostImaga8})`}}>
