        ...
        <div className="widget-timeline-icons pb-3">
            <ul className="timeline">
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className="fs-14 fw-semibold">StumbleUpon is acquired by eBay.</span>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-xl-2 col-sm-3 col-6">
                                    <div className="avatar-list avatar-list-stacked ms-3">
                                        <img src={IMAGES.Avat3} alt="avat" className="avatar avatar-sm rounded-circle" />
                                        <img src={IMAGES.Avat4} alt="avat" className="avatar avatar-sm rounded-circle" />
                                ...
                                <div className="col-xl-1 col-sm-3 col-6 text-end mt-2 mt-sm-0">
                                    <Link to={"#"}  className="btn btn-xxs btn-light">View</Link>
                                </div>
                            </div>
                        </div>
                        <div className="px-3 py-3 mt-3 border border-secondary border-opacity-10 rounded">
                ...
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold">Mashable, a news website and blog, goes live</span>
                ...
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold">05 New Project Files Uploaded</span>
                ...
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold"><Link to={"#"} className="text-primary fw-medium">jQuery.js</Link> was merged into <strong>Google</strong> Task task</span>
                ...
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold"><strong>Hughes</strong> Created & assigned a new task <Link to={"#"} className="text-primary">Design Multistep Registraion Form</Link> to you </span>
                ...
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold">3 Dashboard concepts uploaded</span>
                            <span className="fs-14 d-block">1:56 PM by <span className="text-primary">You</span></span>
                        </div>
                        <div className="p-md-4 p-3 mt-3 border border-secondary border-opacity-10 rounded">
                            <div className="row g-3">
                                <div className="col-md-2 col-4">
                                    <img src={IMAGES.Screen1} alt="screen1" className="w-100 rounded" />
                                </div>
                                <div className="col-md-2 col-4">
                                    <img src={IMAGES.Screen2} alt="screen2" className="w-100 rounded"/>
                                </div>
                                <div className="col-md-2 col-4">
                                    <img src={IMAGES.Screen3} alt="screen1" className="w-100 rounded"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold"><strong>Hughes</strong> Fold Created & assigned a new task <Link to={"#"} className="text-primary">Design Multistep Registraion Form</Link> to you </span>
                            <span className="fs-14 d-block">11:02 PM by <span className="text-primary">Hughes</span></span>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div className="timeline-panel">
                        <div className="clearfix">
                            <span className=" fs-14 fw-semibold">You have received your monthly Affiliate Fee</span>
                            ...
                            <div className="col-lg-8">
                                <div className="alert alert-primary border-primary outline-dashed py-3 px-4 d-flex align-items-center mb-0 mt-3">
                                    ...
                                    <div className="mx-3">
                                        ...
                                        <p className="fs-14 mb-0 text-dark">Securely withdraw money to your bank account, with a $25 fee.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
