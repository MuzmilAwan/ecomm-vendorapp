            ...
            <div className="col-xl-12">
               <div className="welcome-card rounded ps-5 pt-5 pb-4 mt-3 position-relative mb-5">
                  ...
                  <Link className="btn btn-warning btn-rounded" to="/">
                     Learn More{" "}
                     <i className="las la-long-arrow-alt-right ms-4" />
                  </Link>
                     ...
                     <div className="d-flex mt-3 mt-sm-0">                        
                        <Dropdown className="me-3">
                           ...
                           <Dropdown.Menu >
                              ...
                              <Dropdown.Item onClick={()=>setSelectData('Weekly')}>Weekly</Dropdown.Item>
                              <Dropdown.Item onClick={()=>setSelectData('Monthly')}>Monthly</Dropdown.Item>
                           </Dropdown.Menu>
                        </Dropdown>     
                        <Dropdown className="ms-2">
                           ...
                           <Dropdown.Menu >
                              <Dropdown.Item onClick={()=>setSelectData2('2023')}>2023</Dropdown.Item>
                              <Dropdown.Item onClick={()=>setSelectData2('2024')}>2024</Dropdown.Item>
                              <Dropdown.Item onClick={()=>setSelectData2('2025')}>2025</Dropdown.Item>
                           </Dropdown.Menu>
                        </Dropdown>                       
                     </div>
                  </div>
                     ...
                     <div className="row mx-0">
                        <div className="col-sm-12 col-lg-4 px-0">
                           <h2 className="fs-40 text-black font-w600">
                              862,441{" "}
                              <small className="fs-18 ms-2 font-w600 mb-1">
                                 pcs
                              </small>
                           </h2>
