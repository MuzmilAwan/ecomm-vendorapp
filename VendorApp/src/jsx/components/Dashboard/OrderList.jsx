                  ...
                  <div className="card-body px-3 py-3 py-xl-2">
                     <div className="row align-items-center gx-2">
                        <div className="col-xl-3 col-lg-3 col-md-3 d-md-block d-none">
                           <p className="mb-0 fs-13">Lorem Ipsum is simply dummy text of the printing</p>
                        </div>
                                 ...
                                 <div className="media align-items-center">
                                    <span className="me-3">
                                       <svg width="30" height="19" viewBox="0 0 30 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path fillRule="evenodd" clipRule="evenodd" d="M29.3124 0.990819C30.1459 1.71561 30.234 2.97887 29.5092 3.81239L20.7578 13.8765C19.359 15.4851 16.9444 15.7141 15.2681 14.397L11.1176 11.1359L3.87074 17.9564C3.06639 18.7135 1.80064 18.6751 1.04361 17.8708C0.286573 17.0664 0.324929 15.8007 1.12928 15.0436L8.3761 8.22309C9.817 6.86695 12.0329 6.76812 13.5888 7.99062L17.7394 11.2518L26.4908 1.18767C27.2156 0.354158 28.4788 0.266024 29.3124 0.990819Z" fill="var(--primary)" />
                                       </svg>
                                    </span>
                                 ...
                                 <div className="media align-items-center">
                                    <span className="me-3">
                                       <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <rect width="3.54545" height="26" rx="1.77273" transform="matrix(-1 0 0 1 24.8181 0)" fill="var(--primary)" />
                                          <rect width="3.54545" height="18.9091" rx="1.77273" transform="matrix(-1 0 0 1 17.7271 7.09088)" fill="var(--primary)" />
                                          <rect width="3.54545" height="8.27273" rx="1.77273" transform="matrix(-1 0 0 1 10.6362 17.7273)" fill="var(--primary)" />
                                          <rect width="4" height="16" rx="2" transform="matrix(-1 0 0 1 4 10)" fill="var(--primary)" />
                                       </svg>
                                    </span>
                                    <div className="media-body ms-1">
