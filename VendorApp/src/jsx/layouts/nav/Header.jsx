            ...
            <nav className="navbar navbar-expand">
               <div className="collapse navbar-collapse justify-content-between">
                  ...
                  <ul className="navbar-nav header-right">
                     ...
                     <li className="nav-item dropdown notification_dropdown">
                        <Link to={"#"} className={`nav-link bell primary dz-theme-mode ${background.value === "dark" ? "active": ""}`}
                           onClick={ChangeMode}
                        >
                     ...
                     <Dropdown as="li" className="nav-item notification_dropdown">
                        ...
                        <Dropdown.Menu className={`dropdown-menu-right mt-3`} align={"end"}>
                     ...
                     <Dropdown as="li" className="nav-item dropdown header-profile">
                        <Dropdown.Toggle className="nav-link icon-false" to="#" as="div">
                           <img src={profile} width={20} alt="profile" />
                        </Dropdown.Toggle>

                        <Dropdown.Menu
                           className={`dropdown-menu dropdown-menu-right profile mt-2`} align="end"
                        >
